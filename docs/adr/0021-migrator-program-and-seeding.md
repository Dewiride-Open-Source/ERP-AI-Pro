...
- A deployment runs the migrator before rolling the API; a failed migrator leaves the running API untouched, and `status` tells an operator what is pending. The runbook `docs/operations/runbooks/migrations.md` covers the procedure and recovery.
